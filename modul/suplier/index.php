                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($exec)) {
                        ...
                        <tr>
                            ...
                            <a href="modul/akun/aksi_akun.php?act=delete&id_supplier=<?= $data['id_supplier']; ?>" class="text-decoration-none">
                        ...
                        <div class="modal fade" id="editSupplier<?= $data['id_supplier'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="modul/suplier/aksi_suplier.php?act=update&id=<?= $data['id_supplier'] ?>" method="post">
